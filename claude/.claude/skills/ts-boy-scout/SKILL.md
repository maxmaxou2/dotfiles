...
- Rename a poorly named variable -> triggers `ts-clean-names`
- Delete a redundant comment -> triggers `ts-clean-comments`
- Remove dead code or unused imports
- Replace a magic number with a named constant
- Extract a deeply nested block into a well-named function

### Deeper Improvements (When Time Allows)
- Split a function that does multiple things -> triggers `ts-clean-functions`
- Remove duplication (DRY) -> triggers `ts-clean-general`
- Add missing boundary checks
- Improve test coverage -> triggers `ts-clean-tests`
...
| Naming variables, functions, classes | `ts-clean-names` |
| Writing or editing comments | `ts-clean-comments` |
| Creating or refactoring functions | `ts-clean-functions` |
| Reviewing code quality | `ts-clean-general` |
| Writing or reviewing tests | `ts-clean-tests` |
